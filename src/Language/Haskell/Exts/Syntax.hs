...
module Language.Haskell.Exts.Syntax (
  module Language.Haskell.Exts.Syntax.Assoc,
  module Language.Haskell.Exts.Syntax.Binds,
  module Language.Haskell.Exts.Syntax.Boxed,
  module Language.Haskell.Exts.Syntax.Decl,
  module Language.Haskell.Exts.Syntax.Exp,
  module Language.Haskell.Exts.Syntax.Literal,
  module Language.Haskell.Exts.Syntax.Module,
  module Language.Haskell.Exts.Syntax.Names,
  module Language.Haskell.Exts.Syntax.Pattern,
  module Language.Haskell.Exts.Syntax.PXAttr,
  module Language.Haskell.Exts.Syntax.Sign,
  module Language.Haskell.Exts.Syntax.Splice,
  module Language.Haskell.Exts.Syntax.Stmt,
  module Language.Haskell.Exts.Syntax.Type,
  module Language.Haskell.Exts.Syntax.XAttr,
  module Language.Haskell.Exts.Syntax.XName,
...
instance Annotated (Binds__ Exp Decl) where
    ann (BDecls  l _) = l
    ann (IPBinds l _) = l
    amap f (BDecls  l decls) = BDecls (f l) decls
    amap f (IPBinds l ibs)   = IPBinds (f l) ibs

instance Annotated (IPBind_ Exp) where
    ann (IPBind l _ _) = l
